        ...
        <div className="relative bg-butter rounded-4xl overflow-hidden" style={{borderRadius: '32px'}}>
          ...
          <div className="absolute inset-0 pointer-events-none rounded-4xl overflow-hidden" style={{borderRadius: '32px'}}>
            ...
            <div className="absolute inset-0 p-8 md:p-12 lg:p-16 xl:p-12 2xl:p-16 flex flex-col h-full">
              ...
              <div>
                {/* Title */}
                <h3 className="compliance-text text-base md:text-lg lg:text-xl xl:text-lg 2xl:text-xl font-sora font-normal text-black leading-tight mb-4 opacity-0 transform translate-y-4 transition-all duration-150 ease-out">
                A real-time dashboard that automatically flags violations, so stakeholders can act immediately
                </h3>

                {/* Year */}
                <p className="compliance-text text-base md:text-lg lg:text-xl xl:text-lg 2xl:text-xl font-sora font-normal text-black opacity-0 transform translate-y-4 transition-all duration-150 ease-out">
                  2024
                </p>
              </div>
              ...
              <div className="flex justify-end items-end">
                {/* Arrow - bottom right */}
                <svg
                  className="compliance-text w-8 h-8 text-black opacity-0 transform translate-y-4 group-hover:translate-x-1 transition-all duration-150 ease-out"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
